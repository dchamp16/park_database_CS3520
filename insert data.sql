...
-- 45 Events
INSERT INTO Event (name, date, description, MaxParticipants, parkID) VALUES
	('Forest Marathon', '2023-11-10 08:00:00', 'A thrilling marathon through the woods.', 500, 1),
	('Lakeview Yoga', '2023-11-15 07:00:00', 'Morning yoga sessions by the lake.', 100, 2),
	('Mountain Climbing Bootcamp', '2023-11-20 09:00:00', 'Learn the basics of mountain climbing.', 50, 3),
	('Summer Music Fest', '2023-11-25 18:00:00', 'An evening of music, dance and fun.', 1000, 4),
	('Desert Safari Trip', '2023-11-30 10:00:00', 'Experience the magic of the desert.', 200, 5),
	('Bird Watching Workshop', '2023-12-05 06:00:00', 'Spot and learn about various bird species.', 40, 6),
	('Star Gazing Night', '2023-12-10 20:00:00', 'Explore the night sky with astronomers.', 150, 7),
	('Nature Photography Tour', '2023-12-15 10:00:00', 'Capture the beauty of nature.', 75, 8),
	('River Rafting Adventure', '2023-12-20 11:00:00', 'Thrilling water sport in the wild river.', 100, 9),
	('Butterfly Conservation Talk', '2023-12-25 15:00:00', 'Learn about butterflies and conservation.', 60, 10),
	('Jungle Survival Skills', '2024-01-05 09:00:00', 'Master the art of surviving in the wild.', 50, 11),
	('Rock Climbing Challenges', '2024-01-10 10:00:00', 'Climb challenging terrains and cliffs.', 40, 12),
	('Eco Friendly Crafting', '2024-01-15 14:00:00', 'Crafting session using natural materials.', 30, 13),
	('Wildlife Documentary Screening', '2024-01-20 19:00:00', 'Watch a documentary on park wildlife.', 200, 14),
	('Nature Walk and Cleanup', '2024-01-25 09:00:00', 'Walk and help clean the park trails.', 100, 15),
	('Kite Flying Day', '2024-02-05 12:00:00', 'Colorful kites taking over the sky.', 300, 16),
	('Organic Farming Workshop', '2024-02-10 10:00:00', 'Learn the basics of organic farming.', 50, 17),
	('Night Camp and BBQ', '2024-02-15 18:00:00', 'Camp under the stars and enjoy a BBQ.', 100, 18),
	('Wildflower Preservation', '2024-02-20 14:00:00', 'Learn about wildflowers and their importance.', 40, 19),
	('Aquatic Life Exploration', '2024-02-25 11:00:00', 'Discover the aquatic species in the park.', 60, 20),
	('Sculpture Workshop', '2024-03-05 13:00:00', 'Crafting workshop using park elements.', 25, 5),
	('Folk Music Evening', '2024-03-10 17:00:00', 'Experience cultural music in the open.', 500, 3),
	('Cycling Rally', '2024-03-15 08:00:00', 'Cycling through various park trails.', 200, 11),
	('Meditation Retreat', '2024-03-20 07:00:00', 'Relax and meditate amidst nature.', 100, 16),
	('Insect Study Camp', '2024-03-25 09:00:00', 'Understand the tiny world of insects.', 30, 12),
	('Archery Training', '2024-04-05 10:00:00', 'Learn the ancient art of archery.', 40, 12),
	('History of the Park', '2024-04-10 15:00:00', 'Know the history and evolution of the park.', 150, 5),
	('Kayaking Championships', '2024-04-15 12:00:00', 'Race in the waters.', 50, 1),
	('Treasure Hunt', '2024-04-20 10:00:00', 'Exciting treasure hunt for kids and families.', 300, 1),
	('Dance Workshop', '2024-04-25 16:00:00', 'Learn dance forms in the lap of nature.', 100, 1),
	('Fitness Bootcamp', '2024-05-05 08:00:00', 'Intense fitness sessions in the park.', 70, 1),
	('Poetry Under the Stars', '2024-05-10 19:00:00', 'Listen to and recite mesmerizing poetry.', 200, 6),
	('Park Rangers Day', '2024-05-15 10:00:00', 'Celebrate and understand the life of park rangers.', 150, 19),
	('Astronomy Club Meet', '2024-05-20 20:00:00', 'Dive deep into the mysteries of the universe.', 80, 15),
	('Arts and Crafts Fair', '2024-05-25 11:00:00', 'Display of local art and crafts.', 500, 14),
	('Pottery Workshop', '2024-06-05 14:00:00', 'Shape your imagination with clay.', 40, 6),
	('Rope Skills and Knots', '2024-06-10 10:00:00', 'Master different types of knots.', 30, 7),
	('Wildlife Rescue Workshop', '2024-06-15 13:00:00', 'Understand wildlife rescue operations.', 50, 8),
	('Musical Night', '2024-06-20 18:00:00', 'Melodious tunes in the middle of the park.', 800, 10),
	('Herbal Medicine Workshop', '2024-06-25 15:00:00', 'Learn about natural remedies.', 60, 11),
	('Watercolor Painting Class', '2024-07-05 14:00:00', 'Capture the park\'s beauty on canvas.', 35, 15),
	('Film Screening', '2024-07-10 19:00:00', 'Watch a classic film amidst greenery.', 250, 16),
	('Horse Riding Camp', '2024-07-15 09:00:00', 'Learn horse riding from experts.', 40, 3),
	('Food and Culture Fest', '2024-07-20 12:00:00', 'Taste diverse cuisines at the park.', 1000, 7),
	('Gardening Workshop', '2024-07-25 11:00:00', 'Nurture the gardener within you.', 60, 5);
...
-- 30 staffs
INSERT INTO Staff (firstName, lastName, phone, email, roleID) VALUES
	('John', 'Doe', '123-456-7890', 'john.doe@gmail.com', 1),
	('Jane', 'Smith', '123-456-7891', 'jane.smith@gmail.com', 2),
	('Alice', 'Johnson', '123-456-7892', 'alice.johnson@gmail.com', 3),
	('Bob', 'Williams', '123-456-7893', 'bob.williams@gmail.com', 4),
	('Charlie', 'Brown', '123-456-7894', 'charlie.brown@gmail.com', 5),
	('David', 'Jones', '123-456-7895', 'david.jones@gmail.com', 1),
	('Ella', 'Miller', '123-456-7896', 'ella.miller@gmail.com', 2),
	('Frank', 'Davis', '123-456-7897', 'frank.davis@gmail.com', 3),
	('Grace', 'Garcia', '123-456-7898', 'grace.garcia@gmail.com', 4),
	('Hank', 'Rodriguez', '123-456-7899', 'hank.rodriguez@gmail.com', 5),
	('Ivy', 'Martinez', '123-456-7800', 'ivy.martinez@gmail.com', 1),
	('Jack', 'Perez', '123-456-7801', 'jack.perez@gmail.com', 2),
	('Kara', 'Wilson', '123-456-7802', 'kara.wilson@gmail.com', 3),
	('Leo', 'Anderson', '123-456-7803', 'leo.anderson@gmail.com', 4),
	('Mia', 'Taylor', '123-456-7804', 'mia.taylor@gmail.com', 5),
	('Nick', 'Moore', '123-456-7805', 'nick.moore@gmail.com', 1),
	('Olivia', 'Jackson', '123-456-7806', 'olivia.jackson@gmail.com', 2),
	('Paul', 'Martin', '123-456-7807', 'paul.martin@gmail.com', 3),
	('Quinn', 'Harris', '123-456-7808', 'quinn.harris@gmail.com', 4),
	('Rita', 'Thompson', '123-456-7809', 'rita.thompson@gmail.com', 5),
	('Sam', 'Thomas', '123-456-7810', 'sam.thomas@gmail.com', 1),
	('Tina', 'White', '123-456-7811', 'tina.white@gmail.com', 2),
	('Ulysses', 'Lopez', '123-456-7812', 'ulysses.lopez@gmail.com', 3),
	('Vera', 'Lee', '123-456-7813', 'vera.lee@gmail.com', 4),
	('Will', 'Gonzalez', '123-456-7814', 'will.gonzalez@gmail.com', 5),
	('Xena', 'Hernandez', '123-456-7815', 'xena.hernandez@gmail.com', 1),
	('Yara', 'Clark', '123-456-7816', 'yara.clark@gmail.com', 2),
	('Zack', 'Robinson', '123-456-7817', 'zack.robinson@gmail.com', 3),
	('Amy', 'Hall', '123-456-7818', 'amy.hall@gmail.com', 4),
	('Brian', 'Turner', '123-456-7819', 'brian.turner@gmail.com', 5);
